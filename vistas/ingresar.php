...
<body>
    ...
    <form action="../php/i.php" method="POST"   class="validated">
     ...
     <div class="form-group" >
      ...
      <br>
     <input type="text"  class="form-control" name="correo" placeholder="correo@correo.com"  pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" required title="Ejemplo: correo@correo.com" /> 
