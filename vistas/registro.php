...
<body>
 ...
 <div class="formulario_reg" >
    ...
    <table  width="700px" >
      ...
      <td><input type="text"  class="form-control" name="correo" placeholder="correo@correo.com"  pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" required title="Ejemplo: correo@correo.com" />  </td>
      </tr>
      <tr>
